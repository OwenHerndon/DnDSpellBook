...
namespace DnDSpellBook.DependencyResolution {
    using DAL;
    ...
    public class DefaultRegistry : Registry {
        ...
        public DefaultRegistry() {
            ...
            For<ICharacterRepository>().Use<CharacterRepository>();
            For<ISpellRepository>().Use<SpellRepository>();
            For<IAddCharacterRepository>().Use<AddCharacterRepository>();
        }
